...
fields['CRM_PRODUCT_FIELDS'] = [
   ...
   {name: 'userCode', text: 'Хэрэглэгч', width: 40},
...
fields['CRM_PROMOTION_FIELDS'] = [
   ...
   {name: 'rank', text: 'Зэрэглэл', width: 100, align: 'right'},
   {name: 'p_type', text: 'Нэгж', width: 100, align: 'right'},
   {name: 'promo_brand', text: 'Бренд', width: 100, align: 'right'},
...
fields['CRM_STORAGE_FIELDS'] = [
   ...
   {name: 'pty', text: 'Хайрцаг', type: 'float', width: 90, renderer: renderT4Number, align: 'right', summaryType: 'sum', summaryRenderer: renderT4Number},
...
fields['CRM_PRODUCT_TIMEOUT_FIELDS'] = [
   {name: 'id', text: 'ID', width: 50, hidden:true}, 
   {name: 'end_date', type: 'datetime', dateFormat: 'Y-m-d', text: 'Дуусах', width: 120, renderer: renderCreatedDate},
   {name: 'product_id', text: 'ID', width: 50, primary: true, hidden:true}, 
   {name: 'product_code', text: 'Код', width: 50, primary: true, align: 'center'}, 
   {name: 'product_name', text: 'Нэр', width: 150, primary: true, align: 'left'}, 
   {name: 'warehouse_id', text: 'Агуулах', width: 100, primary: true, hidden:true},
   {name: 'warehouse_name', text: 'Агуулах', width: 100, primary: true},
   {name: 'position', text: 'Байршил', width: 170, align: 'left'},
   {name: 'start_date', type: 'datetime', dateFormat: 'Y-m-d', text: 'Үүссэн', width: 120, renderer: renderCreatedDate}
];

Ext.define('CRM_PRODUCT_TIMEOUT', {
	extend: 'Ext.data.Model',
	fields: fields['CRM_PRODUCT_TIMEOUT_FIELDS']
});
...
fields['CRM_REPORT_SALES_PRECENT_FIELDS'] = [
   {name: 'id', text: 'ID', width: 50, hidden:true}, 
   {name: 'deal_id', text: 'Deal ID', hidden: true},
   {name: 'crm_id', text: 'CRM ID', hidden: true},
   {name: 'product_id', text: 'PID', width: 50, hidden: true, align:'center'}, 
   {name: 'product_code', text: 'Code', width: 70, align:'left'}, 
   {name: 'product_barcode', text: 'BarCode', width: 80, align:'left'}, 
   {name: 'product_name', text: 'Product name', width: 200}, 
   {name: 'crm_name', text: 'Харилцагч', align:'left', width: 200},
   {name: 'descr', text: 'Падаан дугаар', width: 200, align: 'right'}, 
   {name: 'type', text: 'Type', hidden: true, align: 'center', width: 70},
   {name: 'precent',  type:'float', text: 'Хувь', width: 100, align: 'right'}, 
   {name: 'warehouse_id', text: 'Warehouse ID', width: 100, hidden: true, align: 'right'}, 
   {name: 'qty', text: 'Ширхэг', type:'float', align: 'right', width: 80, summaryType: 'sum'},
   {name: 'pty', text: 'Хайрцаг', type:'float', align: 'right', width: 80, summaryType: 'sum'},
   {name: 'price', text: 'Үнэ', width: 90, type: 'float', align: 'right', renderer: renderMoney},
   {name: 'amount', text: 'Дүн', type: 'float', width: 100, align: 'right', renderer: renderMoney, summaryRenderer: renderTMoney, summaryType: 'sum'},
   {name: '_date', text: 'Огноо', dateFormat: 'Y-m-d', width: 120, renderer: renderCreatedDate},
   {name: 'unit_size', text: 'Unit size', width: 80, renderer: renderNumber, align: 'right'},
   {name: 'flag', text: 'Flag', width: 80, renderer: renderNumber, align: 'right', hidden: true}
];

Ext.define('CRM_REPORT_SALES_PRECENT', {
	extend: 'Ext.data.Model',
	fields: fields['CRM_REPORT_SALES_PRECENT_FIELDS']
});
...
fields['CRM_REPORT_STORAGE_DAILY_FIELDS'] = [
   ...
   {name: 'sales', type: 'float', width: 85, text: 'Борлуулалт', width: 100, align: 'right', renderer: renderReportNumber, summaryType: 'sum', summaryRenderer: renderTNumber},
   {name: 'promo', type: 'float', width: 85, text: 'Урамшуулал', width: 100, align: 'right', renderer: renderReportNumber, summaryType: 'sum', summaryRenderer: renderTNumber},
   {name: 'sku', type: 'float', width: 85, text: 'SKU', width: 120, align: 'right', renderer: renderReportNumber, summaryType: 'sum', summaryRenderer: renderTNumber},
